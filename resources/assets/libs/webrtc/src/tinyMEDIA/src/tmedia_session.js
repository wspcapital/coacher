...
if(!window.__b_release_mode){
    tmedia_api_add_js_scripts('head',
        'assets/dist/libs/webrtc/src/tinyMEDIA/src/tmedia_session_jsep.js',
        'assets/dist/libs/webrtc/src/tinyMEDIA/src/tmedia_session_roap.js',
        'assets/dist/libs/webrtc/src/tinyMEDIA/src/tmedia_session_ghost.js'
    );
}