...
if(!window.__b_release_mode){
    tsip_api_add_js_scripts('head',
        'assets/dist/libs/webrtc/src/tinySIP/src/headers/tsip_header_Int.js', // 'Content-Length', 'Expires', 'Max-Forwards', 'Min_Expires', 'Min-SE', 'RSeq'
        'assets/dist/libs/webrtc/src/tinySIP/src/headers/tsip_header_NameAddr.js', // 'From', 'To', 'Refer-To', 'Referred-By'
        // 'assets/dist/libs/webrtc/src/tinySIP/src/headers/tsip_header_NameAddrArray.js', #include_in<tsip_header_NameAddr.js> // 'P-Asserted-Identity', 'P-Associated-URI', 'P-Preferred-Identity', 'Path', 'Record-Route', 'Route', 'Service-Route'
        'assets/dist/libs/webrtc/src/tinySIP/src/headers/tsip_header_Str.js', // Call-ID, 'Date', 'Event', 'P-Access-Network-Info', 'P-Charging-Function-Addresses', 'Server', SIP-ETag, SIP-If-Match, User-Agent, Warning, Dummy
        'assets/dist/libs/webrtc/src/tinySIP/src/headers/tsip_header_StrArray.js', // 'Allow', 'Allow-Events', 'Privacy', 'Require', 'Supported'

        'assets/dist/libs/webrtc/src/tinySIP/src/headers/tsip_header_Authorization.js',
        'assets/dist/libs/webrtc/src/tinySIP/src/headers/tsip_header_Contact.js',
        'assets/dist/libs/webrtc/src/tinySIP/src/headers/tsip_header_Content_Type.js',
        'assets/dist/libs/webrtc/src/tinySIP/src/headers/tsip_header_CSeq.js',
        'assets/dist/libs/webrtc/src/tinySIP/src/headers/tsip_header_RAck.js',
        'assets/dist/libs/webrtc/src/tinySIP/src/headers/tsip_header_Refer_Sub.js',
        'assets/dist/libs/webrtc/src/tinySIP/src/headers/tsip_header_Session_Expires.js',
        'assets/dist/libs/webrtc/src/tinySIP/src/headers/tsip_header_Subscription_State.js',
        'assets/dist/libs/webrtc/src/tinySIP/src/headers/tsip_header_Via.js',
        'assets/dist/libs/webrtc/src/tinySIP/src/headers/tsip_header_WWW_Authenticate.js'
    );
}