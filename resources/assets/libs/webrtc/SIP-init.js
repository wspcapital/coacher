...
$(function () {
    ...
    $('#load-vcoach').on('click', function (e) {
        e.preventDefault();
        if (flag == true) {
            $("#video-chat").hide("slow");
            flag = !flag;
            sipUnRegister();
            $(this).text('Join Room');
        }
        else {
            $("#video-chat").show("slow");
            flag = !flag;
            sipRegister();
    ...
    $('#video-call').on('click', function (e) {
        e.preventDefault();
        sipCall("call-audiovideo")
    });

    $('#audio-call').on('click', function (e) {
        e.preventDefault();
        sipCall("call-audio");
    });

    $('#screen-share').on('click', function (e) {
        e.preventDefault();
        sipShareScreen();
    });
    ...
    $('#btnHoldResume').on('click', function (e) {
        e.preventDefault();
        sipToggleHoldResume();
    });
        ...
        try {
            ...
            oSipStack = new SIPml.Stack({
                    ...
                    sip_headers: [
                        ...
                        {name: 'Organization', value: 'Pinnacle Performance Company'}
                    ]
                }
            );
