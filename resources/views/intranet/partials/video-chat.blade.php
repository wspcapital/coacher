    ...
    <div class="row-fluid">
        <div class="span4 well">
            ...
            <table>
                <tr>
                    <td>
                        <input type="text" id="txtDisplayName" value="101" hidden/>
                    </td>
                </tr>
                <tr>
                    <td>
                        <input type="text" id="txtPrivateIdentity" value="101" hidden/>
                    </td>
                </tr>
                <tr>
                    <td>
                        <input type="text" id="txtPublicIdentity" value="sip:101@in-staging.pub" hidden/>
                    </td>
                </tr>
                <tr>
                    <td>
                        <input type="password" hidden id="txtPassword" value="101badpassword-test-pass"/>
                    </td>
                </tr>
                <tr>
                    <td>
                        <input type="text" id="txtRealm" value="in-staging.pub" hidden/>
                    </td>
                </tr>
                {{--<tr>
                ...
                <tr>
                    <td colspan="3">
                        <a class="btn" href="{{  url('/expert') }}" target="_blank">Expert mode?</a>
                    </td>
                </tr>
                --}}
            </table>
            ...
            <table style='width: 100%;'>
                <tr>
                    <td style="white-space:nowrap;">
                        <input type="text" id="txtPhoneNumber" value="102" hidden/>
                    </td>
                </tr>
                <tr>
                    <td colspan="1" align="right">
                        <div class="btn-toolbar" style="margin: 0; vertical-align:middle">
                            ...
                            <div id="divBtnCallGroup" class="btn-group">
                                <button id="btnCall" disabled class="btn btn-primary" data-toggle="dropdown">Call
                                </button>
                                <!-- Call button options -->
                                <ul id="ulCallOptions">
                                    ...
                                    <li></li>
                                    <li id='liScreenShare'>
                                        <a id="screen-share">Screen Share</a></li>
                                    <li class="divider"></li>
