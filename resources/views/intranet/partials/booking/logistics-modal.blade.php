            ...
            <div class="modal-body">
                ...
                <div class="pad-top">
                            ...
                            <div>
                                ...
                                <a class="col-md-2" data-toggle="collapse"
                                   data-target="#trainer-{{$trainer->user_id}}">
                                    <img class="img-responsive hidden-xs" src="{{asset('/assets/dist/img/intranet/booking/logistics/info.png')}}" alt="bio">
                                </a>
                   ...
                   {{-- <p>{{ $booking->location_name }}:
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <p>Start Date <strong>{{ $booking->start_date->format('M d Y') }}</strong></p>
                        </div>
                        <div class="col-md-6">
                            <p>End Date <strong>{{ $booking->end_date->format('M d Y') }}</strong></p>
                        </div>
                    </div>
                    <hr>
