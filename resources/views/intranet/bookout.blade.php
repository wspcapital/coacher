    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xs-12 col-sm-6">
                <div class="user-info">
                    {!! Form::open(['url' => 'intranet/bookout/save', 'method' => 'post', 'id' => 'bookoutForm']) !!}
                    {!! Form::token() !!}
                    {!! Form::text('bookout_id', $bookout->id, ['hidden'=>'true']) !!}

                    <div class="form-group col-xs-12">
                        {!! Form::label('details', 'Description/Notes') !!}
                        {!! Form::textarea('details', $bookout->details,
                        ['class' => 'form-control', 'placeholder' => 'Description/Notes', 'size' => '30x3']) !!}
                    </div>

                    <div class="form-group col-xs-12">
                        {!! Form::label('generalnote', 'Note') !!}
                        {!! Form::text('generalnote', $bookout->generalnote,
                    ...
                    <div class="form-group">
                        <div class="form-group col-xs-12 col-sm-6 {{ $errors->has('start_date') ? ' has-error' : ''}}">
                            ...
                            {!! Form::text('start_date', date('m/d/y',strtotime($bookout->start_date)),
                        ...
                        <div class="form-group col-xs-12 col-sm-6 {{ $errors->has('end_date') ? ' has-error' : ''}}">
                            ...
                            {!! Form::text('end_date', date('m/d/y',strtotime($bookout->end_date)),
